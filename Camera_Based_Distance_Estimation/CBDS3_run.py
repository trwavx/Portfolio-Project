...
ref_person = cv.imread(r'Pictures\person.jpg')
person_data = object_detector(ref_person)
person_width_in_rf = person_data[0][1]

ref_car = cv.imread(r'Pictures\car.jpeg')
car_data = object_detector(ref_car)
car_width_in_rf = car_data[1][1]

ref_motorbike = cv.imread(r'Pictures\motorbike.jpg')
motorbike_data = object_detector(ref_motorbike)
motorbike_width_in_rf = motorbike_data[2][1]

ref_bus = cv.imread(r'Pictures\motorbike.jpg')
bus_data = object_detector(ref_motorbike)
bus_width_in_rf = car_data[2][1]

ref_truck = cv.imread(r'Pictures\motorbike.jpg')
...
capture = cv.VideoCapture(r'Videos\[uncut] SaiGon Day Ride to District 2 Motorcycle Scooter POV Day Drive Vietnam.mp4')
while True:
